...
setwd("D:/FCDados/[04] - Graficos/[01] - InputData/")

dados_netflix <- read.csv("dados_netflix_Dec_2021.csv")
View(dados_netflix)

# Carregando os dados do World Bank
dados_pib <- read.csv("dados_world_bank.csv", header = FALSE)
View(dados_pib)

# Carregando os dados de desigualdade salarial
dados_salario <- read.csv("dados_desigualdade_salarial_harvard.csv")
View(dados_salario)

# Carregando dados do IMDB: 
dados_IMDB <- read_tsv("dados_IMDB.tsv")
View(dados_IMDB)

# Carregando dados dos Top 10 shows da Netflix por país
dados_top10 <- read_excel("top_10_shows_netflix.xlsx")
View(dados_top10)

# Carregando dados de assinantes da Netflix em Julho/2021
dados_sub <- read.csv("assinantes_netflix_jul_2021.csv")
View(dados_sub)

# Carregando dados de códigos ISO dos países
countrycode <- read.csv("wikipedia-iso-country-codes.csv")
View(countrycode)
...
setwd("D:/FCDados/[04] - Graficos/[01] - OutputData/")

# Salva o dataframe produzido até aqui
write.csv(complete, "dataset1.csv", row.names = FALSE)
...
# Salva em disco
write.csv(generocount, "dataset2.csv", row.names = FALSE)
...
# Salva em disco
write.csv(sunburst, "dataset3.csv", row.names = FALSE)
...
# Salva em disco
write.csv(top10sunburst, "dataset4.csv", row.names = FALSE)
...
# Salva em disco
write.csv(nototal, "dataset5.csv", row.names = FALSE)
...
# Salva em disco
write.csv(countrytree, "dataset6.csv", row.names = FALSE)
